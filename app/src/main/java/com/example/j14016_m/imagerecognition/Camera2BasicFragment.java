...
/**
 * Created by J14016_M on 2018/01/14.
 */
...
public class Camera2BasicFragment extends Fragment implements View.OnClickListener, ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    private class ImageSaver implements Runnable {
        ...
        public void run() {
            ...
            //bundle.putByteArray("camera_image", bytes);
            //bundle.putInt("camera_image_length", bytes.length);
            bundle.putSerializable("camera_image", mTextureView);

            ImageDetectFragment fragment = ImageDetectFragment.newInstance();
